...
export const metadata: Metadata = {
  title: "Asset Valuation | Maudit | Majed Alshamsi Auditing",
  description: "Professional Asset Valuation services in Dubai provided by Majed Alshamsi Auditing.",
};
      ...
      <main className="flex-grow pt-32 pb-20">
        ...
        <section className="bg-thm text-white py-16 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 max-w-7xl relative z-10">
            <FadeIn yOffset={20}>
              <h1 className="text-4xl md:text-5xl font-bold uppercase tracking-wide mb-4">Asset Valuation</h1>
              <div className="flex items-center text-sm font-medium text-white/70 uppercase tracking-widest gap-2">
                <span>Home</span>
                <span>/</span>
                <span>Services</span>
                <span>/</span>
                <span className="text-primary">Asset Valuation</span>
              </div>
            </FadeIn>
          </div>
        </section>
              ...
              <div className="lg:col-span-8 order-2 lg:order-1">
                <FadeIn delay={0.2} yOffset={30}>
                  <div className="prose prose-lg max-w-none text-secondary">
                    <h2 className="text-3xl font-bold text-thm uppercase mb-6">About Asset Valuation</h2>
                    <p className="mb-6 leading-relaxed">
                      Our asset valuation services are designed to provide your business with the strategic edge it needs to thrive in Dubai's competitive market. We combine deep industry knowledge with practical application to deliver results that matter.
                    </p>
                    <p className="mb-6 leading-relaxed">
