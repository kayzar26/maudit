...
export const metadata: Metadata = {
  title: "Accounting Outsourcing | Maudit | Majed Alshamsi Auditing",
  description: "Professional Accounting Outsourcing services in Dubai provided by Majed Alshamsi Auditing.",
};
      ...
      <main className="flex-grow pt-32 pb-20">
        ...
        <section className="bg-thm text-white py-16 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 max-w-7xl relative z-10">
            <FadeIn yOffset={20}>
              <h1 className="text-4xl md:text-5xl font-bold uppercase tracking-wide mb-4">Accounting Outsourcing</h1>
              <div className="flex items-center text-sm font-medium text-white/70 uppercase tracking-widest gap-2">
                <span>Home</span>
                <span>/</span>
                <span>Services</span>
                <span>/</span>
                <span className="text-primary">Accounting Outsourcing</span>
              </div>
            </FadeIn>
          </div>
        </section>
