          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex flex-col lg:flex-row items-center justify-between pb-20">
              ...
              <div className="lg:w-1/3 flex justify-center lg:justify-end relative">
                  ...
                  <Link 
                    href="/contact-us" 
                    className="absolute top-0 right-0 md:right-auto md:left-1/2 bg-black/20 backdrop-blur-xl border-4 border-thm rounded-full w-[160px] h-[160px] md:w-[168px] md:h-[168px] flex items-center justify-center group hover:scale-105 transition-transform duration-300 z-20"
                  >
                    <div className="absolute inset-0 animate-[spin_20s_reverse_linear_infinite] flex items-center justify-center pointer-events-none">
                      <svg viewBox="0 0 100 100" className="w-[85%] h-[85%] overflow-visible">
                        <path 
                          ...
                          fill="none"
                        />
                        <text className="fill-white text-[10px] font-black uppercase tracking-[0.2em]">
                    ...
                    <Image 
                      src="/img/overlay/hero-cta-arrow.svg" 
                      alt="Arrow" 
                      width={30} 
                      height={30} 
                      className="group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform relative z-10 brightness-0 invert" 
                    />
                  </Link>
              </div>
            </div>
        ...
        <section className="py-24 md:py-40 bg-zinc-50 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="flex flex-col items-center mb-20">
                <p className="text-primary font-bold tracking-widest uppercase mb-4 text-center">Strategic Financial Solutions</p>
